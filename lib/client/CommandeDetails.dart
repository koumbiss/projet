...
class MyCommandeDetails extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return MyCommandeDetailsState();
  }
}

class MyCommandeDetailsState extends State<MyCommandeDetails> {
  bool visible = false;
  var etat;
  bool annule = false;
  @override
                      ...
                      children: [
                        ...
                        Container(
                            ...
                            child: ElevatedButton(
                                ...
                                onPressed: () async {
                                  await CloudFirestore().updatedata(
                                    widget.id,
                                    "confirmée",
                                  );
                                },
